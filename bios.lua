...
settings.define("bios.init_program", {
    default = "",
    description = [[The program to load on computer startup. Can be used to override the default shell program.]],
    type = "string",
})
...
local ok, err = pcall(parallel.waitForAny,
    function()
        local uInit = settings.get("bios.init_program", "")
        local sShell
        if uInit ~= "" and fs.exists(uInit) then
            sShell = uInit
